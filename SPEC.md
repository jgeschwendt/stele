...
Draft 0.8 · 2026-07-20 · status: refined — gigarefine converged at cap (5 passes, curve 33→21→11→5→3-trivial); 0.8 adds the `.steleignore` scan-exclusion decision from v1 self-hosting
