...
Status: done 2026-09-17 · v0.3.0 released, ten downstream trunks migrated and committed (unpushed) · owner: jlg · execution: opus agents per phase, session model reviews and gates.
